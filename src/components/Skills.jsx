    ...
    return (
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6 mt-6 px-4">
        {skills.map((skill, index) => (
          <div
            key={index}
            className="flex flex-col items-center justify-center bg-white dark:bg-neutral-900 shadow-md hover:shadow-xl transition-shadow duration-300 p-6 rounded-2xl hover:scale-105 transform transition-transform ease-in-out"
          >
